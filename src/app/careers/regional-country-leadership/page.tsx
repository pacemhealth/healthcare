...
import { Search, MapPin, Calendar, Star, ArrowRight, Globe, Filter } from 'lucide-react';
import { useState } from 'react';

export default function RegionalCountryLeadershipJobs() {
      ...
      <section className="relative bg-gradient-to-br from-[#4B2991] to-[#3d1e7d] text-white py-16 px-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="mb-8">
            ...
            <h1 className="text-4xl md:text-5xl mb-4">Regional & Country Leadership Careers</h1>
            <p className="text-xl text-gray-200 max-w-3xl">
              Lead healthcare transformation at scale. Join our leadership team as a country director, regional manager, or field leader driving strategic operations across African markets.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3">
              ...
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl text-[#4B2991]">8 Jobs</h2>
              </div>
...
const leadershipJobs = [
  {
    ...
    description: "Lead all Pacem Health operations in Kenya including distribution, pharmacy services, advisory programs, and strategic partnerships. Drive business growth, manage multi-functional teams, and ensure operational excellence.",
    tags: ["Full-time", "Executive", "Kenya"],
  },
  {
    title: "Regional Operations Director - West Africa",
    location: "Accra, Ghana",
    postedDate: "Posted 2 weeks ago",
    description: "Oversee operations across West African countries (Ghana, Nigeria, Senegal), manage country teams, develop regional strategies, and drive harmonization of systems and processes across markets.",
    tags: ["Full-time", "Executive", "Multi-Country"],
  },
  {
    title: "Country Manager - Nigeria",
    location: "Lagos, Nigeria",
    postedDate: "Posted 3 weeks ago",
    description: "Manage Nigerian operations including supply chain, pharmaceutical services, and business development. Build strategic partnerships, ensure regulatory compliance, and drive revenue growth in Nigeria's dynamic healthcare market.",
    tags: ["Full-time", "Manager", "Nigeria"],
  },
  {
    title: "Regional Advisory Director - East Africa",
    location: "Nairobi, Kenya",
    postedDate: "Posted 1 month ago",
    description: "Lead health systems advisory services across East Africa, manage technical advisory teams, develop client relationships with governments and donors, and oversee implementation of health systems strengthening programs.",
    tags: ["Full-time", "Director", "Multi-Country"],
  },
];
